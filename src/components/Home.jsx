...
const Home = () => {
  UseTitle();
  return (
    <div className="home-container overflow-x-hidden bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
      {/* Header Message */}
      <header className="header-message bg-blue-200 text-blue-800 dark:bg-blue-700 dark:text-blue-200 py-6 text-center text-xl font-semibold shadow">
      ...
      <section className="book-categories-section py-8 dark:bg-gray-800">
      ...
      <section className="why-choose-bookhub py-16 bg-gray-50 dark:bg-gray-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mx-4">
          <div className="feature-card p-6 bg-white dark:bg-gray-700 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 text-center">
      ...
      <section className="how-it-works py-16 bg-blue-50 dark:bg-gray-800 mt-5">
        <h2 className="text-3xl font-semibold text-center mb-12 text-gray-800 dark:text-gray-200">
          How It Works
        </h2>
        <div className="steps-container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mx-4">
          <div className="step-card p-6 bg-white dark:bg-gray-700 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 text-center">
